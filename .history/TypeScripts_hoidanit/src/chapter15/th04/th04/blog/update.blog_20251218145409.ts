...
const actionUpdate = (btnElement: HTMLButtonElement) => {
    btnElement.addEventListener("click", () => {
        ...
        titleElement.value = btnElement.getAttribute("data-update-id")!;
        authorElement.value = btnElement.getAttribute("data-update-id")!;
        contentElement.value = btnElement.getAttribute("data-update-id")!;
    })
}
