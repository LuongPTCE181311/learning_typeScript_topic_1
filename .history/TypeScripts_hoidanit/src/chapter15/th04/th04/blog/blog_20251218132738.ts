    ...
    data.forEach((blog, index) => {
      tableBlog.innerHTML += `
                <tr>
                    ...
                    <td>${blog.content}</td>
                    <td>
                    <button dada-id=${blog.id} class="btn btn-warning">Edit</button>
                    <button dada-id=${blog.id} class="btn btn-danger delete-Btn">Delete</button>
                    </td>
                </tr>
                `;
    });
...
const addNewRowWithJs = (blog: IBlog) => {
  ...
  newRow.innerHTML = `
        <tr>            
                    ...
                    <button dada-id=${blog.id} class="btn btn-danger deleteBtn">Delete</button>
                    </td>
                </tr>
    `;
